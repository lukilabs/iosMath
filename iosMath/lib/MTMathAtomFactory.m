...
+ (NSMutableDictionary<NSString*, MTMathAtom*>*) supportedLatexSymbols
{
    ...
    if (!commands) {
        commands = [NSMutableDictionary dictionaryWithDictionary:@{
                     ...
                     @"dotsc" : [MTMathAtom atomWithType:kMTMathAtomOrdinary value:@"\u2026"],
                     @"dotso" : [MTMathAtom atomWithType:kMTMathAtomOrdinary value:@"\u2026"],
                     @"dotsb" : [MTMathAtom atomWithType:kMTMathAtomOrdinary value:@"\u22ef"],
                     @"dotsm" : [MTMathAtom atomWithType:kMTMathAtomOrdinary value:@"\u22ef"],
                     @"dotsi" : [MTMathAtom atomWithType:kMTMathAtomOrdinary value:@"\u22ef"],
                     ...
                     // ============================================================
                     // KaTeX parity — Phase 1: AMS Symbols & Aliases
                     // ============================================================
                     ...
                     @"dag" : [MTMathAtom atomWithType:kMTMathAtomOrdinary value:@"\u2020"],
                     @"ddag" : [MTMathAtom atomWithType:kMTMathAtomOrdinary value:@"\u2021"],
...
+(NSDictionary<NSString*, NSNumber*> *) fontStyles
{
    ...
    if (!fontStyles) {
        fontStyles = @{
                       ...
                       @"boldsymbol": @(kMTFontStyleBoldItalic),
